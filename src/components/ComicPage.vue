<template>
	<el-main class="pageWidth">
		...
		<div class="main-list">
		<el-row :gutter="10" v-if="comicdata.Comiclist && !isnull">
			<template v-for="(list,index) in comicdata.Comiclist" :key="list+index">
			<el-col :span="5"  v-if="!isNaN(index)">
				<router-link :to="{ name: 'player', query:{mtype:'c',id:list.id}}" >
				<div class="grid-content bg-purple">
				<el-card :body-style="{ padding: '0px'}" shadow="hover">
